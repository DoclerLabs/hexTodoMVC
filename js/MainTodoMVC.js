...
Main.main = function() {
	...
	todoServiceLocator.addMapping(todomvc_service_ITodoService,configuration_TodoLocalStorage,null,false);
	...
	var view = new configuration_js_TodoViewJS(todoList,todoItemCounter,clearCompleted,main,footer,toggleAll,newTodo);
	coreFactory.register("view",view);
	var viewConfig = new hex_ioc_di_MappingConfiguration();
	viewConfig.addMapping(todomvc_view_ITodoView,view,null,false);
...
hex_compiler_assembler_CompileTimeApplicationAssembler.prototype = {
	...
	,getMainExpression: function() {
		return { expr : haxe_macro_ExprDef.EBlock(this._expressions), pos : { file : "hexIoC/src/hex/compiler/assembler/CompileTimeApplicationAssembler.hx", min : 2099, max : 2120}};
	}
...
hex_compiler_core_CompileTimeContextFactory.prototype = {
	...
	,callModuleInitialisation: function() {
		...
		while(_g < modules.length) {
			...
			++_g;
			this._expressions.push({ expr : haxe_macro_ExprDef.EMeta({ name : ":mergeBlock", params : [], pos : { file : "hexIoC/src/hex/compiler/core/CompileTimeContextFactory.hx", min : 14017, max : 14027}},{ expr : haxe_macro_ExprDef.EBlock([{ expr : haxe_macro_ExprDef.ECall({ expr : haxe_macro_ExprDef.EField({ expr : haxe_macro_ExprDef.EConst(haxe_macro_Constant.CIdent(module.getDomain().getName())), pos : { file : "hexIoC/src/hex/compiler/core/CompileTimeContextFactory.hx", min : 13947, max : 13979}},"initialize"), pos : { file : "hexIoC/src/hex/compiler/core/CompileTimeContextFactory.hx", min : 14030, max : 14048}},[]), pos : { file : "hexIoC/src/hex/compiler/core/CompileTimeContextFactory.hx", min : 14030, max : 14050}}]), pos : { file : "hexIoC/src/hex/compiler/core/CompileTimeContextFactory.hx", min : 14028, max : 14053}}), pos : { file : "hexIoC/src/hex/compiler/core/CompileTimeContextFactory.hx", min : 14017, max : 14053}});
		}
...
hex_di_Injector.prototype = {
	...
	,unmap: function(type,name) {
		...
		var mapping = __map_reserved[mappingID] != null?_this.getReserved(mappingID):_this.h[mappingID];
		if(mapping == null) {
			throw new js__$Boot_HaxeError(new hex_di_error_InjectorException("unmap failed with mapping named '" + mappingID + "' @" + hex_log_Stringifier.stringify(this),{ fileName : "Injector.hx", lineNumber : 168, className : "hex.di.Injector", methodName : "unmap"}));
		}
	...
	,_createMapping: function(type,name,mappingID) {
		...
		if(__map_reserved[mappingID] != null?_this.getReserved(mappingID):_this.h[mappingID]) {
			throw new js__$Boot_HaxeError(new hex_di_error_InjectorException("Mapping named '" + mappingID + "' is already processing @" + hex_log_Stringifier.stringify(this),{ fileName : "Injector.hx", lineNumber : 283, className : "hex.di.Injector", methodName : "_createMapping"}));
		}
...
hex_ioc_parser_xml_XMLParserUtil.getMapType = function(xml) {
	var s = xml.get("map-type");
	if(s != null) {
		var a = s.split(",");
		var _g = [];
		var _g1 = 0;
...
var hex_ioc_vo_ConstructorVO = function(id,type,args,factory,singleton,injectInto,ref,mapTypes,staticRef) {
	if(injectInto == null) {
		injectInto = false;
	}
...
hex_ioc_vo_ConstructorVO.prototype = $extend(hex_ioc_vo_AssemblerVO.prototype,{
	toString: function() {
		return "(" + "id:" + this.ID + ", " + "type:" + this.type + ", " + "arguments:[" + Std.string(this["arguments"]) + "], " + "factory:" + this.factory + ", " + "singleton:" + this.singleton + ", " + "injectInto:" + Std.string(this.injectInto) + ", " + "ref:" + this.ref + ", " + "mapTypes:" + Std.string(this.mapTypes) + ", " + "staticRef:" + this.staticRef + ")";
	}
...
var hex_mdvc_driver_IInput = function() { };
$hxClasses["hex.mdvc.driver.IInput"] = hex_mdvc_driver_IInput;
hex_mdvc_driver_IInput.__name__ = ["hex","mdvc","driver","IInput"];
hex_mdvc_driver_IInput.prototype = {
	__class__: hex_mdvc_driver_IInput
};
...
var hex_mdvc_driver_Input = function(driver) {
	this._outputs = [];
	this._driver = driver;
};
$hxClasses["hex.mdvc.driver.Input"] = hex_mdvc_driver_Input;
hex_mdvc_driver_Input.__name__ = ["hex","mdvc","driver","Input"];
hex_mdvc_driver_Input.__interfaces__ = [hex_mdvc_driver_IInput];
hex_mdvc_driver_Input.prototype = {
	switchOn: function() {
		var _g = 0;
	...
	,unplug: function(output) {
		if(this._outputs.indexOf(output) != -1) {
			HxOverrides.remove(this._outputs,output);
		}
		output.disconnect(this._driver);
	}
	,__class__: hex_mdvc_driver_Input
};
var hex_mdvc_model_IOutput = function() { };
$hxClasses["hex.mdvc.model.IOutput"] = hex_mdvc_model_IOutput;
hex_mdvc_model_IOutput.__name__ = ["hex","mdvc","model","IOutput"];
hex_mdvc_model_IOutput.prototype = {
	__class__: hex_mdvc_model_IOutput
};
var hex_mdvc_model_IOutputOwner = function() { };
$hxClasses["hex.mdvc.model.IOutputOwner"] = hex_mdvc_model_IOutputOwner;
hex_mdvc_model_IOutputOwner.__name__ = ["hex","mdvc","model","IOutputOwner"];
...
var todomvc_model_ITodoConnection = function() { };
$hxClasses["todomvc.model.ITodoConnection"] = todomvc_model_ITodoConnection;
todomvc_model_ITodoConnection.__name__ = ["todomvc","model","ITodoConnection"];
todomvc_model_ITodoConnection.prototype = {
	__class__: todomvc_model_ITodoConnection
};
...
todomvc_driver_ITodoDriver.__interfaces__ = [todomvc_model_ITodoConnection];
todomvc_driver_ITodoDriver.prototype = {
	__class__: todomvc_driver_ITodoDriver
};
var todomvc_driver_TodoDriver = function() {
	this.input = new hex_mdvc_driver_Input(this);
};
...
$hxClasses["todomvc.model.TodoItem"] = todomvc_model_TodoItem;
todomvc_model_TodoItem.__name__ = ["todomvc","model","TodoItem"];
todomvc_model_TodoItem.prototype = {
	__class__: todomvc_model_TodoItem
};
var todomvc_model_TodoModel = function() {
	this.output = new todomvc_model__$_$Output_$Class_$For_$_$ITodoConnection();
};
...
var todomvc_model__$_$Output_$Class_$For_$_$ITodoConnection = function() {
	this._inputs = [];
};
$hxClasses["todomvc.model.__Output_Class_For__ITodoConnection"] = todomvc_model__$_$Output_$Class_$For_$_$ITodoConnection;
todomvc_model__$_$Output_$Class_$For_$_$ITodoConnection.__name__ = ["todomvc","model","__Output_Class_For__ITodoConnection"];
todomvc_model__$_$Output_$Class_$For_$_$ITodoConnection.__interfaces__ = [todomvc_model_ITodoConnection,hex_mdvc_model_IOutput];
todomvc_model__$_$Output_$Class_$For_$_$ITodoConnection.prototype = {
	...
	,removeTodo: function(item) {
		...
		while(_g < _g1.length) {
			var input = _g1[_g];
			++_g;
			input.removeTodo(item);
		}
	}
	,__class__: todomvc_model__$_$Output_$Class_$For_$_$ITodoConnection
};
var todomvc_module_TodoModule = function(serviceConfig,viewConfig) {
	hex_mdvc_module_Module.call(this);
	this.getLogger().info("TodoModule initialized",{ fileName : "TodoModule.hx", lineNumber : 25, className : "todomvc.module.TodoModule", methodName : "new"});
...
todomvc_module__$TodoModule_TodoModuleConfig.prototype = $extend(hex_mdvc_config_stateless_StatelessModuleConfig.prototype,{
	configure: function() {
		...
		this.get(todomvc_driver_ITodoDriver).input.plug(this.get(todomvc_model_ITodoModel).output);
	}
...
hex_mdvc_config_stateless_StatelessModuleConfig.__INJECTION_DATA = { methods : [], name : "hex.mdvc.config.stateless.StatelessModuleConfig", props : [{ key : "", type : "hex.di.IDependencyInjector", name : "injector", isOpt : false}], ctor : { order : 0, isPost : false, name : "new", isPre : false, args : []}};
